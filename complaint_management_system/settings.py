...
SECRET_KEY = 'django-insecure--^j9(dh)(a-swl7$&rosdt8&%6s=8=ha0e*c7lh8tm34=8mlt('
...
# Don't allow cached authenticated pages
SECURE_BROWSER_XSS_FILTER = True

# Optional: Automatic session timeout (e.g., 15 minutes)
...
DEFAULT_FROM_EMAIL = 'Grievance Redressal Admin'
